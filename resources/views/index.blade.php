          ...
          <div class="row">
            ...
            <div class="col-md-6 m-t-20">
              <select>
                ...
                <option value="2">Real Estate/Development</option>
                <option value="3">Energy/Power/Fuel</option>
                <option value="4">Electrician/ Construction/ Repair</option>
                <option value="5">Agro based Industry</option>
